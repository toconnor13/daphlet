...
SECRET_KEY = '8l(mo$zcv_!)(n)am28ovp#9)d4k4j6qkj=4t*ft+ea9*#5(m1'
...
MIDDLEWARE_CLASSES = (
    ...
    'django.contrib.sessions.middleware.LoginFormMiddleware',
...
ROOT_URLCONF = 'daphlet.urls'

# Python dotted path to the WSGI application used by Django's runserver.
WSGI_APPLICATION = 'daphlet.wsgi.application'

TEMPLATE_DIRS = (
		'/home/sheefrex/code/daphlet/templates'
